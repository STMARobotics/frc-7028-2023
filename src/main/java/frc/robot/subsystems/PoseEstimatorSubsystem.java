...
public class PoseEstimatorSubsystem extends SubsystemBase {
  ...
  // robot.
  private static final Transform2d CAMERA_TO_ROBOT = new Transform2d(new Translation2d(0, 0), new Rotation2d(0));
  ...
  private static final Matrix<N1, N1> localMeasurementStdDevs = VecBuilder.fill(Units.degreesToRadians(0.1));
  private static final Matrix<N3, N1> visionMeasurementStdDevs = VecBuilder.fill(0.01, 0.01, Units.degreesToRadians(0.1));
  ...
  public void periodic() {
    ...
    poseEstimator.update(drivetrainSubsystem.getGyroscopeRotation(), drivetrainSubsystem.getModuleStates());
    ...
    //       Transform3d camToTarget = res.getBestTarget().getCameraToTarget();
  ...
  public void resetFieldPosition() {
    poseEstimator.resetPosition(
      new Pose2d(getCurrentPose().getTranslation(), new Rotation2d()), drivetrainSubsystem.getGyroscopeRotation());
  }
